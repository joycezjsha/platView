  ...
  <div class="city-index-div">
    <div class="city-index_container">
      ...
      <div class="city-index_content">
        <el-table :data="indexDatas" :default-sort = "{prop: 'week_radio', order: 'descending'}" :row-style="getRowClass" :header-row-style="getRowClass" :header-cell-style="getRowClass">
  ...
  methods: {
    ...
    addArea(data){
      ...
      data.forEach((e,i)=>{
        ...
        lonlats.push(lonlats[0][0],lonlats[1][1]);
        let jsonData = {
    ...
    addAreaIdentify(data){
      ...
      data.forEach((item,i)=>{
        ...
        this.mapAddItems.popups.push('arealayerId_'+i);
