<template>
  <div class="city-index-div">
    ...
    height="55vh" :default-sort = "{prop: 'week_radio', order: 'descending'}" :row-style="getRowClass" :header-row-style="getRowClass" :header-cell-style="getRowClass"  @click='clickHandle(scope.row)'>
...
export default {
  ...
  clickHandle(item){
    this.$emit('setSelectItems',item.city,item.id)
  },
