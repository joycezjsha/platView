<template>
  <div class="traffic-index-div">
    <div class="traffic-index_container">
      ...
      <div class='xian_order'><span class="xian_order--city">{{selectItem.city}}</span>在全国排名:<span class="xian_order--city">{{order_xian}}</span></div>
...
import from '@/assets/css/color.scss';
export default {
  name: "TCruise",
  data() {
    return {
      map: {},
      indexDatas: [],
      selectItem:{"city":"西安",order_xian:8}
    };
  },
  mounted() {
