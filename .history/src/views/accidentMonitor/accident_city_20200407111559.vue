      ...
      <div class="city-accident_content">
         <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="全部" name="first">
            <el-table :data="indexDatas" style="width: 100%" height="55vh" :default-sort = "{prop: 'week_radio', order: 'descending'}" :row-style="getRowClass" :header-row-style="getRowClass" :header-cell-style="getRowClass"><el-table-column fixed type="index" label="No" width="50"></el-table-column>
          ...
          <el-tab-pane label="122" name="second">122</el-tab-pane>
          <el-tab-pane label="互联网" name="third">互联网</el-tab-pane>
          <el-tab-pane label="视频巡查" name="fourth">视频巡查</el-tab-pane>
        </el-tabs>
      </div>
    </div>
  </div>
