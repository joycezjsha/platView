  ...
  <div class="city-index-div">
    <div class="city-index_container">
      ...
      <div class="car-flow_content ">
        ...
        <div class='car-table-query' v-if="activeName=='自定义'">
        ...
        <span v-else>{{tipTxt[activeName]}}</span>
        <ul :class="activeName=='自定义'?'car-flow_content_table car-flow_content_table-':'car-flow_content_table'">
...
export default {
  ...
  data() {
    return {
      ...
      timeRange:'',
      tipTxt:{'实时':'实时：统计上一个小时（15:00-16:00）的流动情况','今天':'今天：统计上今天（00:00-16:00的流动情况','昨天':'昨天：统计上昨天全天的流动情况'}
    };
  },
  mounted() {
