    ...
    <div class="city-index_container">
      ...
      <div class="car-flow_content ">
        ...
        <div class='all_statics'>
          <div><span>陕西省</span><br/><span>{{allStatics.count}}</span></div>
          <div><span>进入:+{{allStatics.in}}</span><br/><span>流出：-{{allStatics.out}}</span></div>
          <div><span>进出比：</span><br/><span>{{allStatics.radio}}</span></div>
        </div>
