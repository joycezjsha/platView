<template>
  <div class="overview-statics">
   <div class='overview-statics--tab'>
     <div><el-button type="primary">今日警情</el-button><span></span>{{datas.jq.count}}起</div>
     <div>
   ...
   <div class='overview-statics--tab'>
     <div><el-button type="primary">本月事故</el-button><span></span>{{datas.sg.count}}起</div>
     <div>
    ...
    <div class='overview-statics--tab'>
     <div><el-button type="primary">活跃电警</el-button><span></span>{{datas.dj.count}}个</div>
     <div>
