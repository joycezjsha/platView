  ...
  <div class="overview-left-div">
    ...
    <div class='overview-left-div--center'>
       ...
       <div class='center_statics'>
         <div>陕西省<br/><span class="center_statics_">{{passCarCount.todayCount}}</span></div>
         <div>
            <div>进入<br/><span class="row_value_">{{trailCallCount.todayCount}}</span></div>
            <div>流出<br/><span class="row_value_">{{trailCallCount.yestodayCount}}</span></div>
         </div>
         <div></div>
       </div>
    </div>
