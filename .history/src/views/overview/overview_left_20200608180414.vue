        ...
        <div class="front">
          <el-card class="box-card boxstyle">
            ...
            <div class="top-container">
              ...
              <div class='top-container-row-'>
                <div>今日上传<br/><span class="row_value_">{{passCarCount.todayCount}}<span style='font-size:0.7vw;'>次</span></span></div>
                <div>昨日上传<br/><span class="row_value_">{{passCarCount.yesterdayCount}}<span style='font-size:0.7vw;'>次</span></span></div>
              </div>
            </div>
          </el-card>
        </div>
        <div class="back">
          <el-card class="box-card boxstyle">
            ...
            <div class="top-container">
              ...
              <div class='top-container-row-'>
                <div>今日调用<br/><span class="row_value_">{{trailCallCount.todayCount}}</span>次</div>
                <div>昨日调用<br/><span class="row_value_">{{trailCallCount.yesterdayCount}}</span>次</div>
              </div>
            </div>
          </el-card>
        </div>
      ...
      <m-title label='境内路况监测' img_type=1  style='width:7vw'></m-title>
       <ul class="traffic-index_content_table">
          <li class="index-item" v-for="(item,i) in trafficDatas" :key="i" :id="item.id">
            ...
            <p><span>平均速度:<span class="text">{{item.averageSpeed}}km/h</span></span>
            <span>路长:<span class="address-name text">{{item.length}}km</span></span></p>
          </li>
        </ul>
    </div>
