<template>
  <div class="overview-statics">
   <div class='overview-statics--tab'>
     <div><el-button type="primary">今日警情</el-button><span></span>{{datas.jq.count}}</div>
     <div>
     ...
     <div><span class='label'>重大警情</span><span class='value'>{{datas.jq.history}}</span>起</div>
   </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      datas:{
        ...
        sg:{count:13512,history:'+123',yestoday:'-122',main:'0'},
        dj:{count:11512,history:'+123',yestoday:'-122',main:'0'}
      }
    };
  },
  mounted() {
