      ...
      <div v-if="flag">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>过车数据</span>
            <el-button style="float: right; padding: 3px 0" type="text" icon="el-icon-edit">详细情况</el-button>
          </div>
          <div class="top-container">
            <div class='top-container-row'>历史过车数据：</div>
            <div class='top-container-row'><div>今日上传</div><div>昨日上传</div></div>
          </div>
        </el-card>
      </div>
      <div v-else>
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>轨迹查询</span>
            <el-button style="float: right; padding: 3px 0" type="text">详细情况</el-button>
          </div>
          <div class="top-container">
            <div>轨迹接口调用次数：</div>
