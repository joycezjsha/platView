  ...
  <div class="overview-info">
    <div class="overview-info_container">
      ...
      <div class="boxstyle">
        ...
        <m-line-chart :chart_data="chart_data" c_id='overViewsumCountChange' style='width:100%;height:20vh'></m-line-chart>
      </div>
      <div class="boxstyle">
        <m-title label='车辆保有量' img_type=1  style='width:7vw;'></m-title>
        <m-line-chart c_id='accurCreateChange' style='width:100%;height:20vh'></m-line-chart>
      </div>
    </div>
  </div>
</template>
