  ...
  <div class="overview-info">
    <div class="overview-info_container">
      ...
      <div class="boxstyle">
        ...
        <bar-chart c_id='accurCreateChange' :chart_data="car_chart_data" style='width:100%;height:25vh'></bar-chart>
      </div>
    </div>
  </div>
</template>
          ...
          if (response && response.status == 200) {
            ...
            if (data.errcode == 0) {
              ...
              for(let key in _data.data){
                car_data.xdata.push(key);
                car_data.ydata.push(_data.data[key].inventory);
              }
