<template>
  <div class="accident-statics-div">
    <div class="accident-statics_container">
      ...
      <div class='accident-statics--tab'>
        <el-row><i class='el-icon-bell'></i>事故总数:<span class="statics--tab--value">{{staticsData.sum}}(其中重大事故:{{staticsData.esplish}})</span></el-row>
         <el-row>受伤:<span class="statics--tab--value">{{staticsData.injury}}人</span>&nbsp;&nbsp;|&nbsp;&nbsp;死亡:<span class="statics--tab--value">{{staticsData.injury}}人</span></el-row>
      </div>
