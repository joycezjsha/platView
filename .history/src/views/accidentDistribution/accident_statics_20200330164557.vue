    ...
    <div class="accident-statics_container">
      ...
      <div class="accident-statics_content">
        <div> <i class="el-icon-collection-tag">事故类型：</i>
            <el-row v-for="(item,index) in sg_sort_data" :key="index"><el-col :span="14">{{item.name}}</el-col><el-col :span="6">{{item.value}}起</el-col><el-col :span="6">{{item.radio}}</el-col></el-row>
        </div>
        <div>事故发生数量变化：
