  ...
  <div class="accident-statics">
    <div class="accident-statics_container">
      ...
      <div class='accident-statics--tab'>
        <div><span class="--tab-title"><i class='el-icon-bell'></i>事故总数:</span><span class="statics--tab--value"><span class="statics_value">{{staticsData.sum}}</span>(其中重大事故:<span class="statics_value">{{staticsData.esplish}})</span></span></div>
