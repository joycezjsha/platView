  ...
  <div class="accident-statics-div">
    <div class="accident-statics_container">
      ...
      <div class='accident-statics--tab'>
        <el-row><i class='el-icon-bell'></i>事故总数:<span class="xian_order--city">{{staticsData.sum}}(其中重大事故:{{staticsData.esplish}})</span></el-row>
         <el-row><i class='el-icon-bell'></i>事故总数:<span class="xian_order--city">{{selectItem.order}}</span></el-row>
      </div>
