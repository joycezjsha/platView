<template>
  <div class="city-index-div">
    <div class="city-index_container">
      ...
      <div class="xian_order">
        <span class="xian_order--city">{{selectItem.city}}</span>在全国排名:
        <span class="xian_order--city">{{selectItem.order}}</span>
      </div>
    ...
    <traffic-inde-charts ref="traffic"></traffic-inde-charts>
  </div>
</template>
