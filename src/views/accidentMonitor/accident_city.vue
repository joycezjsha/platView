<template>
  <div class="city-accident-div boxstyle">
    ...
    @current-change="handleCurrentChange">
        ...
        <el-table v-else :data="groupDatas" style="width: 100%" height="80%" highlight-current-row :default-sort = "{prop: 'week_radio', order: 'descending'}" :row-style="getRowClass" :header-row-style="getRowClass" :header-cell-style="getRowClass" @row-click='handle'>
          <el-table-column type="index" label="No" width="50"></el-table-column>
